  ...
  return (
    <>
      <div className="flex justify-center mt-5">
        <MDBCard className="max-h-full bg-blue-800 flex justify-center w-full">
          ...
          >
            <i className="fas fa-map-marker-alt text-4xl white-text lg:ml-16"></i>
          ...
          <div
            className="flex justify-start animate transition duration-500 ease-in-out  
                        transform hover:-translate-y-1 hover:scale-110 m-4"
          >
            <i className="fas fa-envelope pr-2 text-4xl white-text lg:ml-16"></i>
          ...
          <div
            className="flex justify-start animate transition duration-500 ease-in-out  
                        transform hover:-translate-y-1 hover:scale-110 m-4"
          >
            <i className="fas fa-phone pr-2 text-4xl white-text lg:ml-16"></i>
