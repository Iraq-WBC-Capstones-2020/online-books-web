    ...
    <>
      <div className="flex justify-end">
        ...
        >
          ...
          >
            <i className="fas fa-map-marker-alt text-4xl white-text ml-18"></i>
          ...
          >
            <i className="fas fa-envelope pr-2 text-4xl white-text ml-18"></i>
            <p className="text-gray-400 ml-1 mr-1">
              contact@example.com
              <br />
              info@example.com
            </p>
          ...
          <div
            className="flex justify-start animate transition duration-500 ease-in-out  
                        transform hover:-translate-y-1 hover:scale-110  m-4"
          >
            <i className="fas fa-phone pr-2 text-4xl white-text ml-18"></i>
